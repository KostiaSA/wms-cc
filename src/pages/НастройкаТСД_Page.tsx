...
export class НастройкаТСД_Page extends React.Component<IНастройкаТСД_PageProps> {
    ...
    render() {
        ...
        return (
            <div className={"app cy-nastroika-tsd " + (appState.getActivePageId() == this.props.pageId ? "active-window active-win" : "")} style={{ display: this.props.visible ? "" : "none", backgroundColor: "whitesmoke", padding: 10, width: "100%" }}>
