...
export class Информация_о_задании_Page extends React.Component<IИнформация_о_задании_PageProps> {
    ...
    render() {
        ...
        return (
            <div className={"app " + (appState.getActivePageId() == this.props.pageId ? "active-window cy-task-info-page" : "")} style={{ display: this.props.visible ? "" : "none", backgroundColor: "whitesmoke", padding: 10, width: "100%" }}>
